...
class UIHelper {
  ...
  static init(BuildContext context) {
    ...
    var screenHeight = media.size.height;
    var screenWidth = media.size.width;

    safeAreaHeight = screenHeight - (media.padding.top + media.padding.bottom);
    safeAreaWidth = screenWidth - (media.padding.left + media.padding.right);
  }
